...
IDE_Morph.prototype.openIn = function (world) {
    ...
    world.reactToDropOf = function (morph) {
        if (!(morph instanceof DialogBoxMorph)) {
            if (world.activeHand().grabOrigin) {
                morph.slideBackTo(world.activeHand().grabOrigin);
            } else {
                world.activeHand().grab(morph);
            }
        }
    };
...
IDE_Morph.prototype.duplicateSprite = function (sprite) {
    ...
    duplicate.setPosition(this.world().activeHand().position());
        ...
        function () {
            ...
            inp.addEventListener(
                ...
                function () {
                    ...
                    myself.filePicker = null;
                    world.activHand().processDrop(inp.files);
                },
                false
            );
...
StageHandleMorph.prototype.mouseDownLeft = function (pos) {
    ...
    this.step = function () {
        var newPos, newWidth;
        if (world.activeHand().mouseButton) {
            newPos = world.activeHand().bounds.origin.x + offset;
