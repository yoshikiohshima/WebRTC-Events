...
SpriteMorph.prototype.mouseEnterDragging = function () {
    ...
    obj = this.world().activeHand().children[0];
...
StageMorph.prototype.reportMouseX = function () {
    ...
    if (world) {
        return (world.activeHand().position().x - this.center().x) / this.scale;
    }
    return 0;
};
...
StageMorph.prototype.reportMouseY = function () {
    var world = this.world();
    if (world) {
        return (this.center().y - world.activeHand().position().y) / this.scale;
    }
    return 0;
};
